...
# sudo wget --header="Authorization: token gxp_LifB59C5hKxxxxxxxrvtTgEcwczeHtu" -O terraform.sh "https://raw.githubusercontent.com/prabhatraghav/scripts/master/terraform.sh"

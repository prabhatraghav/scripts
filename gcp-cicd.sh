...
# sudo wget --header="Authorization: token gxp_Lif5hKpFtxxxx3gEcwcz1eHtu" -O gcp-cicd.sh "https://raw.githubusercontent.com/prabhatraghav/scripts/master/gcp-cicd.sh"
